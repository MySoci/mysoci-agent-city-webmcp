...
The first viewport may show: “MySoci Agent City”, “A MySoci prototype”, “Discover”, “Plan”, “About”, “Judge Mode”, “New York, this Saturday”, “Discover the city together.”, the three seeded event names, “Agent Activity”, “Saturday plan”, the supplied example prompt, “Send”, and confirmation/undo controls required by the workflow.

## Responsive behavior

- Desktop: discovery canvas and activity rail share the viewport.
- Mobile: map, selected event, plan, activity, then prompt composer stack vertically.
